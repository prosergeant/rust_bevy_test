...
-   `src/plugins`: Этот модуль содержит основную игровую логику, разделенную на плагины для различных аспектов игры:
    ...
    -   `bird.rs`: Управляет движением птицы, прыжками (через мышь и клавиатуру) и появлением/исчезновением.
...
### Управление
- **Мышь**: 
  - Левая клавиша: Прыжок птицы во время игры
  - Клик по кнопкам в главном меню и экране Game Over
- **Клавиатура**:
  - `Пробел`: Прыжок птицы во время игры и перезапуск из состояния Game Over
...
- Клавиатурный ввод для управления игрой (пробел для прыжка)
- Мышинный ввод для взаимодействия с элементами интерфейса и управления игрой (левая клавиша для прыжка)
- Визуальная обратная связь для улучшения пользовательского опыта
- Гибридное управление: поддержка и мыши, и клавиатуры для прыжка птицы
